...
[![AI Travel Agent Demo](https://img.youtube.com/vi/-wO4pSNL2YY/maxresdefault.jpg)](https://youtu.be/-wO4pSNL2YY)
...
When the browser calls `/chat`, the HTTP request enters the embedded Tomcat server and is processed through Spring MVC:
